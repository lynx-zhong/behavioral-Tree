...
public class MoveAttackAI : BTTree 
{
	...
	protected override void Init () 
	{
		...
		// Actions
		BTPingXingNode run = new BTPingXingNode(BTPingXingNode.ParallelFunction.Or);
        ...
        // 3.1逃离节点
        // "Escape"作为一个并行节点
        // "Or"表示当并行节点的任何子节点结束时，并行节点结束。
        BTPingXingNode escape = new BTPingXingNode(BTPingXingNode.ParallelFunction.Or, checkOrcInSight);
		{
		...
		{
			BTPingXingNode parallel = new BTPingXingNode(BTPingXingNode.ParallelFunction.Or);
			{
